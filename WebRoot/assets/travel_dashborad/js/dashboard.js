...
function setTopTenTable() {
    ...
    $('#tblTopTen').bootstrapTable({
        ...
        url: "/ds/dataApiQuery/lvyou_jiashicang_topn",
...
function getData() {
    var url = '/ds/dataApiQuery/lvyou_jiashicang_qushi';
    var bannerurl = '/ds/dataApiQuery/lvyou_jiashicang_banner';
    ...
    $.getJSON(bannerurl, param, function (json) {
        if(json.code == 0){
