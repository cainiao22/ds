        ...
        var Y = function () {
            ...
            this.getDate1 = function (e) {
                ...
                var a = r.target.value.split(/,|，/).pop(),
                    o = {context: t, url: "/ds/getWordsByTag?tag=" + t.state.tag + "&value=" + a},
            ...
            x = n.n(T), S = n(284), E = n.n(S), C = function (t) {
                ...
                return g()(n, t), m()(n, [{
                    ...
                    key: "render", value: function () {
                        ...
                        }, "查看"))), M.a.createElement("div", {className: "group-details"}, this.state.aggregations.map(function (e, t) {
                            return M.a.createElement("div", {
                                key: t,
                                className: "detail-block border-grey border-radius"
                            }, M.a.createElement("p", null, e.name), a()(e.data).map(function (t, n) {
                                return M.a.createElement("div", {
                                    key: "child" + n,
                                    className: "flex-cont"
