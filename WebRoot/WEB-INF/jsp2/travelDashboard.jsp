...
<head>
    ...
    <link rel="stylesheet" href="./assets/travel_dashborad/css/morris.css"/>
    <link href="./assets/travel_dashborad/css/bootstrap.min.css" rel="stylesheet" type="text/css"/>
    ...
    <link href="./assets/plugin/animate/animate.css" rel="stylesheet" type="text/css"/>
...
<script src="./assets/travel_dashborad/js/morris.min.js"></script>
<script src="./assets/travel_dashborad/js/raphael-min.js"></script>
...
<script src="./assets/travel_dashborad/js/app.js"></script>

<script src="./assets/travel_dashborad/js/waves.js"></script>
<script src="./assets/travel_dashborad/js/echarts.common.min.js"></script>

<script src="./assets/travel_dashborad/js/dashboard.js"></script>

<script type="text/javascript" src="./assets/travel_dashborad/js/moment-with-locales.min.js"></script>
<script type="text/javascript" src="./assets/plugin/datepicker/js/bootstrap-datepicker.js"></script>
<script type="text/javascript" src="./assets/plugin/datepicker/locales/bootstrap-datepicker.zh-CN.min.js"></script>
<script type="text/javascript" src="./assets/plugin/daterangepicker/daterangepicker.js"></script>
<script type="text/javascript" src="./assets/plugin/select2/js/select2.js"></script>
<script type="text/javascript" src="./assets/plugin/animateNumber/jquery.animateNumber.min.js"></script>
...
//            todayHighlight : true,
        ...
        $.getJSON("/ds/dataApiQuery/jiashicang_shaixuanweidu?dimension=city",{},function (data) {
            if(data.code!=0){
//                swal("提示",data.errorMsg, "success");
        ...
        $.getJSON("/ds/dataApiQuery/jiashicang_shaixuanweidu?dimension=c1",{},function (data) {
            if(data.code!=0){
//                swal("提示",data.errorMsg, "success");
            }else{
...
//                    swal("提示",data.errorMsg, "success");
        ...
        $('#first').change(function() {
            ...
            //重新填充二级品类option
            var fVal = $(this).val();
            $.getJSON("/ds/dataApiQuery/jiashicang_shaixuanweidu?dimension=c2&condition="+fVal,{},function (data) {
                if(data.code!=0){
//                    swal("提示",data.errorMsg, "success");
                }else{
