                                        ...
                                        <div class="tabbable-custom  ">
                                            <ul class="nav nav nav-tabs   ">
                                                <li class="active"  style="width:40%;text-align: center;">
                                                    <a href="#tab_1" data-toggle="tab" > 订单金额</br><div id="total_price"></div>  <div id="total_price_rate"  class="label label-sm" style="line-height:2"></div> </a>
                                                </li>
                                                <li   style="width:28%;text-align: center;">
                                                     <a href="#tab_2" data-toggle="tab" > 订单量</br><div id="order_num"></div> <div id="order_num_rate" class="label label-sm"  style="line-height:2"></div></a>
                                                </li>
                                                <li   style="width:28%;text-align: center;">
                                                       <a href="#tab_3" data-toggle="tab" >购买人数</br><div id="member_num"></div>   <div id="member_num_rate"  class="label label-sm" style="line-height:2"></div></a>
                                                </li>
...
<![endif]-->
 ...
 $(function(){
	 ...
	 $.post('./dataApiQuery/realTimeOrderTend',{dt:maxRealTime,value:'sum(total_price )',table:'rt_order_sub',product_no:'productno'},function(res1){
	 ...
	 $.post('./dataApiQuery/realTimeOrderTend',{dt:maxRealTime,value:'count(distinct parent_code)',table:'rt_order_sub',product_no:'productno'},function(res1){
		 $.post('./dataApiQuery/realTimeOrderHistoryTend',{type:'order_num'},function(res2){
			 initChart1('c2',res1.data,res2.data, '实时订单量趋势','订单量','订单量');
		 });
	 });
	 $.post('./dataApiQuery/realTimeOrderTend',{dt:maxRealTime,value:'count( DISTINCT mid)',table:'rt_order_base',product_no:'product_no'},function(res1){
	 ...
	 $.post('./dataApiQuery/realTimeOrderCityRank',{dt:maxRealTime,value:'sum(total_price )',table:'rt_order_sub',product_no:'productno'},function(res){
		 initChart2('c4',res.data, '','销售额','销售额');
	 });
	 $.post('./dataApiQuery/realTimeOrderProductRank',{dt:maxRealTime,value:'sum(total_price )',table:'rt_order_sub',product_no:'productno'},function(res){
		 initChart2('c5',res.data, '','销售额','销售额');
	 });
	 $.post('./dataApiQuery/realTimeOrderWareRank',{dt:maxRealTime,value:'sum(total_price )',table:'rt_order_sub',product_no:'productno'},function(res){
		 $('#c6').empty();
	 ...
	 $.post('./dataApiQuery/realTimeOrderCityRank',{dt:maxRealTime,value:'count(distinct parent_code)',table:'rt_order_sub',product_no:'productno'},function(res){
		 initChart2('c7',res.data, '','订单量','订单量');
	 });
	 $.post('./dataApiQuery/realTimeOrderProductRank',{dt:maxRealTime,value:'count(distinct parent_code)',table:'rt_order_sub',product_no:'productno'},function(res){
		 initChart2('c8',res.data, '','订单量','订单量');
	 });
	 $.post('./dataApiQuery/realTimeOrderWareRank',{dt:maxRealTime,value:'count(distinct parent_code)',table:'rt_order_sub',product_no:'productno'},function(res){
		 $('#c9').empty();
		  for(var i=0;i<res.data.length;i++){
				 var row=res.data[i];
	 ...
	 $.post('./dataApiQuery/realTimeOrderCityRank',{dt:maxRealTime,value:'count( DISTINCT mid)',table:'rt_order_base',product_no:'product_no'},function(res){
