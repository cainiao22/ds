...
<div class="group clearfix" id="form_city1" style="display: none;">
	<label class="groupName">城市筛选: </label> <label class="span3">
		选择国家: <select id="city_state" multiple="multiple">
	</select>
	</label> <label class="span2">查询类型: <input type="radio"
		name="queryType" value="1" />行政区域
...
<div class="group clearfix" id="form_city2" style="display: none;">
...
<div class="group clearfix" id="form_city3" style="display: none;">
	<label class="groupName" style="visibility: hidden;">城市筛选: </label> <label
