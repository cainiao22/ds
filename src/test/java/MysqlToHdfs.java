...
public class MysqlToHdfs {
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        DBConfiguration.configureDB(conf, "com.mysql.jdbc.Driver","jdbc:mysql://10.37.5.111:3306/devds","ds", "123456!");
        ...
        DBInputFormat.setInput(job, TblsRecord.class,"test2", null, "id", fields);
