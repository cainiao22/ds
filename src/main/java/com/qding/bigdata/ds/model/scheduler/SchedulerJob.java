...
public class SchedulerJob extends BaseModel {
	...
	private String parentJobKey; // 父任务Key
	...
	private Integer schdStatus;
	private String schdPeriod;
	
	private Integer dtOffset;
	private String cronCofig;
	...
	public Integer getDtOffset() {
		return dtOffset;
	}

	public void setDtOffset(Integer dtOffset) {
		this.dtOffset = dtOffset;
	}

	public Integer getSchdStatus() {
		return schdStatus;
	}

	public void setSchdStatus(Integer schdStatus) {
		this.schdStatus = schdStatus;
	}

	public String getSchdPeriod() {
		return schdPeriod;
	}

	public void setSchdPeriod(String schdPeriod) {
		this.schdPeriod = schdPeriod;
	}
	...
	public String getCronCofig() {
		return cronCofig;
	}

	public void setCronCofig(String cronCofig) {
		this.cronCofig = cronCofig;
	}
