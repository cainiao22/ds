...
public class MainController extends BasicController {
  ...
  /*@RequestMapping("/dwQueryMonitor")
  public ModelAndView dwQueryMonitor(HttpServletRequest request) {
	  ModelAndView modelAndView = initModelAndView();
	  modelAndView.addObject(Constant.SIDEBAR_MENU, SideBarMenu.数仓SQL运行状态);
	  return modelAndView;
