...
public enum CommonDataHandlerEnum {
    ...
    SQL116("SQL116", "commonDataSqlHandler"),
    SQL242("SQL242", "commonDataSqlHandler"),
    PRESTO("PRESTO", "commonDataSqlHandler"),
    IMPALA("IMPALA", "commonDataSqlHandler"),
    MYSQL("MYSQL", "commonDataSqlHandler"),
